...
public class PaymentConfig {
    ...
    public static final String RETURNURL ="http://localhost:3000/detailPayment/"; //"http://localhost:8080/payment/return";
...
//    Please update the "your_tmn_code", "your_return_url" and "your_hash_secret_key" with your own values according to your VNPAY account and configuration. This code is for sandbox environment, please update the payment URL to the production environment URL for real payments.
